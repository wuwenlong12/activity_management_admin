...
export const register = (
  ...
  http.post<any, ResponseData<null>>(API.USERS_REGISTER, {
    username,
    email,
    password,
    auth_code,
...
export const getVerificationCode = (email: string) =>
  http.get<any, ResponseData<null>>(API.USERS_EMAIL, {
    params: {
      email,
    },
  });
...
export const login = (email: string, password: string) =>
  ...
  export const logout = () =>
    http.delete<any, ResponseData<null>>(API.USERS_LOGOUT, { withCredentials: true });
...
export const getUserDetails = () =>
  http.get<any, ResponseData<null>>(API.USERS_DETAILS, { withCredentials: true });
...
export const updateUserDetails = ({
  ...
  http.patch<any, ResponseData<null>>(
    API.USERS_DETAILS,
    {
      username,
      email,
